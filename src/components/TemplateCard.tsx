  ...
  return (
    <div className="glass-card group overflow-hidden transition-all duration-300 hover:border-primary-500/30 hover:shadow-lg hover:shadow-primary-500/10">
      ...
      >
        {/* Badge */}
        {badge && (
          <div className="absolute left-3 top-3 rounded-full bg-black/40 backdrop-blur-sm px-2.5 py-1 text-[10px] font-semibold text-white">
            {badge}
          </div>
        )}
        ...
        {/* Duration */}
        {duration && (
          <div className="absolute right-3 top-3 flex items-center gap-1 rounded-full bg-black/40 backdrop-blur-sm px-2.5 py-1 text-[10px] text-white">
      ...
      <div className="p-5">
        ...
        <p className="mb-3 text-sm text-gray-400 leading-relaxed">{description}</p>

        {/* Uses */}
        {uses && (
          <div className="mb-4 flex items-center gap-1.5 text-[11px] text-gray-500">
